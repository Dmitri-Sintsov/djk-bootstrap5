...
# pip3 install twine
# twine upload -r test dist/djk-bootstrap5-0.1.0.tar.gz
...
setup(
    name='djk-bootstrap5',
    version=version,
    description="""Bootstrap 5 UI for django-jinja-knockout.""",
    long_description=readme,
    long_description_content_type='text/x-rst',
    author='Dmitriy Sintsov',
    author_email='questpc256@gmail.com',
    url='https://github.com/Dmitri-Sintsov/djk-bootstrap5',
    packages=[
        'djk_ui',
    ],
